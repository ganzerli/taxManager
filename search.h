...
class Search {
    ...
    int getMenuInput(string filepath);
    ...
    vector<vector<string>> change(vector<vector<string>> vectorOfAllDays, int userInput , string filepath);
    int printValues(vector<vector<string>> vectorOfAllDays, int userInput , string filepath);
